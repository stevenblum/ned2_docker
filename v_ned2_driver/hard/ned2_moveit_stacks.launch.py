...
logger = logging.get_logger("ned2_moveit_stacks.launch")

def generate_launch_description():
    

    niryo_driver_pkg = get_package_share_directory("niryo_ned_ros2_driver")
    niryo_description_pkg = get_package_share_directory("niryo_ned_description")
    ros2_stacks_pkg = get_package_share_directory("ros2_stacks")

    urdf_file = os.path.join(
        niryo_description_pkg,
        "urdf/ned2",
